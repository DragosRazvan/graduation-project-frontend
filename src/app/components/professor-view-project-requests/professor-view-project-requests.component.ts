...
projects = [
    { id: 1, title: 'AI Assistant', status: "accepted", student: 'Alice Johnson' },
    { id: 2, title: 'Blockchain Voting', status: "pending", student: 'Bob Smith' },
    { id: 3, title: 'IoT Weather Station', status: "pending", student: 'Charlie Brown' }
  ];
}
